...
contract CrossChainValidator is ERC7579ValidatorBase, IValidationModule {
    ...
    address public liteKeyStore;
    uint256 public constant LITE_KEY_STORE_OWNERS_SLOT = 0;

    constructor(IStorageVerifier _storageVerifier, address _liteKeyStore) {
        storageVerifier = _storageVerifier;
        liteKeyStore = _liteKeyStore;
    }
        ...
        returns (ValidationData)
    {
        ...
        if (liteKeyStore != storageProofData.account.accountAddress) revert InvalidTargetAccount();
